...
//				 0.85*1.82998};
  ...
  Double_t h_aerogel_l = 0.95;
  Double_t h_aerogel_z0 = 2.55;
  Double_t h_aerogel_theta0 = eta2theta( 1.21 ); //~ 35 / 180. * TMath::Pi(); 
  ...
  c_ephenix->Print("detectorGeometry_v1_ePhenix.png");
  c_ephenix->Print("detectorGeometry_v1_ePhenix.eps");
  ...
  c_sphenix->Print("detectorGeometry_v1_sPhenix.png");
  c_sphenix->Print("detectorGeometry_v1_sPhenix.eps");
  ...
  c_yoke->Print("detectorGeometry_v1_yoke.png");
  c_yoke->Print("detectorGeometry_v1_yoke.eps");
